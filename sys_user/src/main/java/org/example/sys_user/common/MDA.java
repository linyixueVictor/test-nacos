package org.example.sys_user.common;
...
public class MDA {
     ...
     */
    public static final String CLIENT_SECRET = "oauth2";

    /**
     * 认证服务器登陆地址
     */
    public static final String OAUTH_LOGIN_URL = "http://authcenter/oauth/token";
